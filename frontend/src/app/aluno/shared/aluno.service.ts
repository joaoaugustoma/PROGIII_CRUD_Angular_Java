...
export class AlunoService {
  ...
  public salvar(aluno: Aluno): Observable<Aluno>|undefined{
    if(!aluno.id){
      return this.http.post<Aluno>(this.urlBackend+'/api/v1/aluno/',aluno)
    }else{
      return this.http.patch<Aluno>(this.urlBackend+'/api/v1/aluno/'+aluno.id, aluno)
    }
    
  }
  public getById(id: number): Observable<Aluno>|undefined{
    return this.http.get<Aluno>(this.urlBackend+'/api/v1/aluno/'+id)
  }

  public remover(id: number): Observable<Aluno>|undefined{
